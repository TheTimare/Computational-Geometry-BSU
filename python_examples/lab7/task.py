...
def dynamic_convex_hull(points: list, latest_convex_hull: list):
    ...
    if len(points) > 3:
        ...
        if get_point_position_to_convex_polygon(new_point, latest_convex_hull) == 'in':
        ...
        if get_point_position_to_line(new_point, latest_convex_hull[-1], latest_convex_hull[0]) == "left":
            ...
            print("RIGHT CASE ============================")
            # start_index = 0, когда не правая сторона начинается не с 0, длина разрыва между первым и последним
            # индексами правых сторон больше одной стороны
            start_index = 0 if right_edges_indexes[0] != 0 else gap_index - 1
            end_index = gap_index
...
def test_left_delta_many():
    points = [Point(8, 1), Point(15, 5.5), Point(9.5, 9), Point(3, 8), Point(1, 5), Point(1.5, 1), Point(19, 9)]
    draw_points(points)
    convex_hull = [Point(8, 1), Point(15, 5.5), Point(9.5, 9), Point(3, 8), Point(1, 5), Point(1.5, 1)]
    # draw_convex_hull(convex_hull, "red")
    convex_hull = dynamic_convex_hull(points, convex_hull)
    draw_convex_hull(convex_hull, "blue")


def test_left_delta_one_four_sides():
    points = [Point(5.5, 3), Point(7, 7), Point(1, 4), Point(9, 6)]
    draw_points(points)
    convex_hull = [Point(5.5, 3), Point(7, 7), Point(1, 4)]
    # draw_convex_hull(convex_hull, "red")
    convex_hull = dynamic_convex_hull(points, convex_hull)
    draw_convex_hull(convex_hull, "blue")


def test_left_delta_one_three_sides():
    points = [Point(5.5, 3), Point(7, 7), Point(1, 4), Point(9, 9)]
    draw_points(points)
    convex_hull = [Point(5.5, 3), Point(7, 7), Point(1, 4)]
    # draw_convex_hull(convex_hull, "red")
    convex_hull = dynamic_convex_hull(points, convex_hull)
...
def test_right_delta_many():
    points = [Point(8, 1), Point(15, 5.5), Point(9.5, 9), Point(3, 8), Point(1, 5), Point(1.5, 1), Point(14.5, -2)]
    draw_points(points)
    convex_hull = [Point(8, 1), Point(15, 5.5), Point(9.5, 9), Point(3, 8), Point(1, 5), Point(1.5, 1)]
    # draw_convex_hull(convex_hull, "red")
    convex_hull = dynamic_convex_hull(points, convex_hull)
...
def test_right_delta_one_three_sides():
    points = [Point(5.5, 3), Point(7, 7), Point(1, 4), Point(7.5, 1.5)]
    draw_points(points)
    convex_hull = [Point(5.5, 3), Point(7, 7), Point(1, 4)]
    # draw_convex_hull(convex_hull, "red")
    convex_hull = dynamic_convex_hull(points, convex_hull)
...
def test_right_last_edge_only():
    points = [Point(3, 10), Point(0, 5), Point(1, 5), Point(5, 7)]
    draw_points(points)
    convex_hull = [Point(3, 10), Point(0, 5), Point(1, 5)]
    # draw_convex_hull(convex_hull, "red")
    convex_hull = dynamic_convex_hull(points, convex_hull)
    draw_convex_hull(convex_hull, "blue")


def test_right_last_edges():
    points = [Point(23, 25), Point(13, 25), Point(7, 24), Point(4, 11), Point(3, 6), Point(14, 0), Point(23, 7),
              Point(25, 14), Point(25, 15), Point(29, 19)]
    draw_points(points)
    convex_hull = [Point(23, 25), Point(13, 25), Point(7, 24), Point(4, 11), Point(3, 6), Point(14, 0), Point(23, 7),
                   Point(25, 14), Point(25, 15)]
    # draw_convex_hull(convex_hull, "red")
    convex_hull = dynamic_convex_hull(points, convex_hull)
    draw_convex_hull(convex_hull, "blue")
...
def init():
    init_generation()
    # test_left_delta_many()
    # test_left_delta_one_four_sides()
    # test_left_delta_one_three_sides()
    # test_right_delta_many()
    # test_right_delta_one_three_sides()
    # test_right_last_edge_only()
    # test_right_last_edges()
    plt.grid(True)
